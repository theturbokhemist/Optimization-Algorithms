...
##############################################################################################################################################################################################################
fv_object_false_default_10000_0.02_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                         normalize_with_reference = FALSE, scoring_method = "Default", numModels = 10000, integrateStepSize = 0.02)
fv_object_false_default_10000_0.02_reference_10000_0.02$fitness_values
############################################
fv_object_false_default_10000_0.1_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                         normalize_with_reference = FALSE, scoring_method = "Default", numModels = 10000, integrateStepSize = 0.1)
fv_object_false_default_10000_0.1_reference_10000_0.02$fitness_values
############################################
fv_object_true_default_10000_0.02_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                         normalize_with_reference = TRUE, scoring_method = "Default", numModels = 10000, integrateStepSize = 0.02)
fv_object_true_default_10000_0.02_reference_10000_0.02$fitness_values
############################################
fv_object_false_PCs_10000_0.02_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                        normalize_with_reference = FALSE, scoring_method = "PCs", numModels = 10000, integrateStepSize = 0.02)
fv_object_false_PCs_10000_0.02_reference_10000_0.02$fitness_values
############################################
fv_object_true_PCs_10000_0.02_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                     normalize_with_reference = TRUE, scoring_method = "PCs", numModels = 10000, integrateStepSize = 0.02)
fv_object_true_PCs_10000_0.02_reference_10000_0.02$fitness_values
############################################
fv_object_true_PCs_10000_0.1_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                    normalize_with_reference = TRUE, scoring_method = "PCs", numModels = 10000, integrateStepSize = 0.1)
fv_object_true_PCs_10000_0.1_reference_10000_0.02$fitness_values

############################################
fv_object_false_PCs_10000_0.1_reference_10000_0.02 <- generate_fitness_value_object(individual = ref_state1, reference_individual_object = reference_individual_object_10000_0.02, 
                                                                                   normalize_with_reference = FALSE, scoring_method = "PCs", numModels = 10000, integrateStepSize = 0.1)
fv_object_false_PCs_10000_0.1_reference_10000_0.02$fitness_values
#########################individual#####################################################################################################################################################################################
...
##########
pop5 <- population(sample_rset = reference_rset_10000_0.02, population_size = 5)
pop6 <- population(sample_rset = reference_rset_10000_0.02, population_size = 6)
pop7 <- population(sample_rset = reference_rset_10000_0.02, population_size = 7)
pop8 <- population(sample_rset = reference_rset_10000_0.02, population_size = 8)

fv_objects_list_pop5 <- selection(pop5, reference_individual_object = reference_individual_object_10000_0.02, integrateStepSize = 0.1, scoring_method = "Default")
fv_objects_list_pop6 <- selection(pop6, reference_individual_object = reference_individual_object_10000_0.02, integrateStepSize = 0.1, scoring_method = "Default")
fv_objects_list_pop7 <- selection(pop7, reference_individual_object = reference_individual_object_10000_0.02, integrateStepSize = 0.1, scoring_method = "Default")
fv_objects_list_pop8 <- selection(pop8, reference_individual_object = reference_individual_object_10000_0.02, integrateStepSize = 0.1, scoring_method = "Default")

reproduction_test_pop5 <- reproduction(selections_object = fv_objects_list_pop5); length(reproduction_test_pop5)
reproduction_test_pop6 <- reproduction(selections_object = fv_objects_list_pop6); length(reproduction_test_pop6)
reproduction_test_pop7 <- reproduction(selections_object = fv_objects_list_pop7); length(reproduction_test_pop7)
reproduction_test_pop8 <- reproduction(selections_object = fv_objects_list_pop8); length(reproduction_test_pop8)
...
GA_R_RACIPE_test1 <- GA_R_RACIPE(reference_individual_object = reference_individual_object_10000_0.02, population_size = 10, max_generations = 6, mutation_rate = 2, mutation_intensity = 0.6, mutation_method = "Random", mating_method = "Random", saving_frequency = 2,
                               min_score = "NA", scoring_method = "Default", normalize_with_reference = TRUE, numModels = 2000, integrateStepSize = 0.02)


GA_R_RACIPE_test1$skips_object
GA_R_RACIPE_test1

top_fv_vec1 <- top_fv_vec
plot(top_fv_vec1)

GA_R_RACIPE_test$skips_object
for (l in 1:length(GA_R_RACIPE_test$generations_object[[1]])) {
  print(GA_R_RACIPE_test$generations_object[[1]][[l]]$fitness_values_sum)
  
}

for (l in 1:length(GA_R_RACIPE_test$generations_object[[1]])) {
  print(GA_R_RACIPE_test$generations_object[[2]][[l]]$fitness_values_sum)
  
}

for (l in 1:length(GA_R_RACIPE_test$generations_object[[1]])) {
  print(GA_R_RACIPE_test$generations_object[[3]][[l]]$fitness_values_sum)
  
}

for (l in 1:length(GA_R_RACIPE_test$generations_object[[1]])) {
  print(GA_R_RACIPE_test$generations_object[[4]][[l]]$fitness_values_sum)
  
}


GA_R_RACIPE_test2 <- GA_R_RACIPE(reference_individual_object = reference_individual_object_10000_0.02, population_size = 9, max_generations = 50, mutation_rate = 1, mutation_intensity = 0.75, mutation_method = "Random",
                                min_score = "NA", scoring_method = "Default", normalize_with_reference = TRUE, numModels = 2000, integrateStepSize = 0.02)

GA_R_RACIPE_test2$skips_object

unlist(GA_R_RACIPE_test2$generations_object$`generation_ 50`$`ind_ 1`$individual)
unlist(GA_R_RACIPE_test2$generations_object$`generation_ 50`$`ind_ 2`$individual)
unlist(GA_R_RACIPE_test2$generations_object$`generation_ 50`$`ind_ 3`$individual)
unlist(GA_R_RACIPE_test2$generations_object$`generation_ 50`$`ind_ 2`$individual)

GA_R_RACIPE_test$skips_object
GA_R_RACIPE_test$generations_object$`generation_ 1`$`ind_ 1`$fitness_values_sum
GA_R_RACIPE_test[[1]]$`ind_ 1`$fitness_values_sum
GA_R_RACIPE_test[[20]]$`ind_ 1`$fitness_values_sum

# unlist(GA_R_RACIPE_test[[19]]$4123
# unlist(GA_R_RACIPE_test[[20]]$1234
for (l in 1:length(GA_R_RACIPE_test[[19]])) {
  print(GA_R_RACIPE_test[[19]][[l]]$fitness_values_sum)
  
} 
for (l in 1:length(GA_R_RACIPE_test[[20]])) {
  print(GA_R_RACIPE_test[[20]][[l]]$fitness_values_sum)
  
}       
GA_R_RACIPE_test2
       
unlist(GA_R_RACIPE_test[[19]]$`ind_ 4`$individual)
unlist(GA_R_RACIPE_test[[20]]$`ind_ 1`$individual)
##############################################################################################################################################################################################################

# selection <- function(generation, reference_individual_object, generations_list, counter = counter, numModels = 10000, scoring_method = "PCs") {
#   
#   fitness_values_list <- vector(mode = "list", length = length(generation))
#   fitness_values <- vector(length = length(generation))
#   skip <- vector(length = length(generation)/2)
#   
#   for (i in 1:length(generation)) {
#     
#     
#     
#     if (counter > 1 & i <= length(skip)) {
#       
#       for (j in 1:length(skip)) {
#         
#         skip[j] <- as.logical(identical(generation[[i]], generations_list[[counter-1]][[j]]))
#         
#         
#       }
#       
...
#     }
#     
#     if (counter > 1 & sum(skip) > 0 & i <= length(skip) & counter%%10 != 0) {
#       
#       fitness_values_list[[i]] <- fvs_list[[counter-1]][[which(skip == TRUE)[1]]]
#       print(paste0("sum(fitness_values_list[[", i, "]]", sum(fitness_values_list[[i]])))
...
# 
# 
# GA_R_RACIPE <- function(topology, reference_rset, population_size = 16, number_of_generations = 10, numModels = 2000, mutation_rate = 1, score_min = NULL, scoring_method = "PCs",
...
#                             means_ref = means_reference, sds_ref = sds_reference, pc_ref = pc_reference, scoring_method = scoring_method, counter = generations_counter)
#       
...
#                              K_upper = K_upper, TH_lower = TH_lower, TH_upper = TH_upper, N_lower = N_lower, N_upper = N_upper, FC_lower = FC_lower, FC_upper = FC_upper)
#     
#     while(score_target > score_min) {
#       
#       
#       generations_list <<- rlist::list.append(generations_list, generation)
#       print(paste("Generation:", length(generations_list)))
#       
#       selected <- selection(generation = generation, reference_expression = reference_expression, sample_rset = reference_rset, threshold_df = threshold_df, numModels = numModels,
#                             means_ref = means_reference, sds_ref = sds_reference, pc_ref = pc_reference, scoring_method = scoring_method, counter = generations_counter)
#       
#       generations_list <<- rlist::list.append(generations_list, generation)
#       fvs_list <<- rlist::list.append(fvs_list, fitness_values_list)
#       
#       score_target <- sum(unlist(fitness_values_list[[1]]))
#       print(score_target)
#       
#       generation <- reproduction(selected = selected, mutation_rate = mutation_rate, sample_rset = reference_rset, G_lower = G_lower, G_upper = G_upper, K_lower = K_lower,
#                                  K_upper = K_upper, TH_lower = TH_lower, TH_upper = TH_upper, N_lower = N_lower, N_upper = N_upper, FC_lower = FC_lower, FC_upper = FC_upper)
...
###
GA_R_RACIPE(topology_TS, reference_rset = reference_rset, population_size = 40, number_of_generations = 100, mutation_rate = 3, numModels = 10000, N_upper = 5, score_min = 0.08)
